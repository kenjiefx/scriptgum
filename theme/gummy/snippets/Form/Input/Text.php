...
<fieldset xblock="/Form/Input/Text" class="fieldset__input <?php echo $withBoxShadow; ?> padding-x-7 background-color-primary-extra-light:disabled padding-y-9 text-4 font-weight-300 border-radius-extra-small-2" <?php echo $disabled; ?> <?php echo $disabledValue; ?>>
    <?php if ($label): ?>
